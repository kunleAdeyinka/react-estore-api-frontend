//this component contains the logic to update a product
window.UpdateProductComponent = React.createClass({
    ...
    // on mount - fetch all categories and one product data
    componentDidMount(){
      //read categories
      this.serverRequestCategoires = $.get("http://localhost/estoreapi/category/read.php",
        function(categoires){
          //console.log(categoires);
          this.setState({
            categories: categoires.records
          });
        }.bind(this)
      );
    ...
    componentWillUnmount(){
      this.serverRequestCategoires.abort();
    ...
    onSave(e){
      ...
      $.ajax({
        url: "http://localhost/estoreapi/product/update.php",
        type : "POST",
          ...
          <div>
              {
                ...
                <div className='alert alert-success'>Product was updated.</div> : null
              }

              {
                  this.state.successUpdate == "Unable to update product." ?
                      <div className='alert alert-danger'> Unable to update product. Please try again.</div> : null
              }
